/*
  ...
  1. Problème
    - Les évaluations sont marquées comme "evaluee_referent" alors que le référent n'a pas encore évalué
    - Cela empêche les référents de pouvoir évaluer les objectifs des collaborateurs

  2. Solution
    - Ajouter une fonction pour vérifier si une évaluation référent est réellement complète
    - Corriger les statuts des évaluations existantes
    - Mettre à jour les déclencheurs pour éviter ce problème à l'avenir
*/
