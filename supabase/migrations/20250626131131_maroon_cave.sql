/*
  ...
  1. Mise à jour des contraintes de statut
    - Mise à jour de la contrainte pour evaluations_objectifs avec nouveaux statuts
    
  2. Nouvelles fonctions
    - `calculate_average_evaluation_score` : Calcule le score moyen d'une auto-évaluation
    - `notify_referent_of_evaluation` : Notifie les référents des nouvelles auto-évaluations
    
  3. Triggers
    - Trigger pour notifier automatiquement les référents
    
  4. Politiques RLS mises à jour
    - Politiques spécifiques pour les auto-évaluations
    - Accès pour collaborateurs, référents, coaches et admins
    
  5. Index et vues
    - Index pour améliorer les performances
    - Vue complète des auto-évaluations avec informations contextuelles
*/
