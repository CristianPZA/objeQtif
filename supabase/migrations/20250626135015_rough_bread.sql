/*
  ...
  1. Nouveaux statuts d'évaluation
    - en_attente_referent: Auto-évaluation soumise, en attente de l'évaluation référent
    - evaluee_referent: Évaluée par le référent
    - finalisee: Évaluation complète terminée

  2. Fonctions de calcul
    - calculate_final_score: Calcule la note finale pondérée
    - notify_coach_of_final_evaluation: Notifie le coach quand l'évaluation est finalisée

  3. Vues pour le coaching
    - v_coaching_evaluations: Vue spéciale pour les coaches
    - Mise à jour de v_auto_evaluations_completes

  4. Politiques RLS mises à jour
    - Accès spécifique pour les coaches
    - Gestion des évaluations référent
*/
...
DROP POLICY IF EXISTS "Coaches peuvent voir évaluations coachés" ON evaluations_objectifs;
...
-- Supprimer et recréer la vue v_auto_evaluations_completes pour éviter les conflits
