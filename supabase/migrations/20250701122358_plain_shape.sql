/*
  ...
  1. Problème
    - Lorsque le collaborateur soumet son auto-évaluation, le statut passe directement à "evaluee_referent"
    - Le référent n'a pas la possibilité d'évaluer car le statut indique que c'est déjà fait

  2. Solution
    - Modifier la fonction notify_referent_of_evaluation pour mettre le statut à "en_attente_referent"
    - Ajouter une vérification pour s'assurer que le statut est correctement mis à jour
*/
