/*
  # Correction du workflow d'évaluation référent

  1. Problème
    - Les référents ne peuvent pas évaluer les fiches projet même quand elles sont en attente
    - Le statut "en_attente_referent" n'est pas correctement géré
    - Les évaluations passent directement à "evaluee_referent" sans intervention du référent

  2. Solution
    - Mise à jour de la contrainte de statut pour evaluations_objectifs
    - Correction de la fonction notify_referent_of_evaluation
    - Ajout d'un trigger pour notifier les coaches lors de la finalisation
    - Mise à jour des politiques RLS pour les référents

  3. Changements
    - Statuts possibles: brouillon, soumise, en_attente_referent, evaluee_referent, finalisee, rejetee
    - Workflow: soumise → en_attente_referent → evaluee_referent → finalisee
*/
